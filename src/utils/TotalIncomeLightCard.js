...
const TotalIncomeLightCard = ({ isLoading, texte }) => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <CardWrapper border={false} mb={5} content={false}>
          <Box sx={{ p: 2 }} style={{ width: '300px', height: '70px' }}>
            <List sx={{ py: 0 }}>
              <ListItem alignItems="center" disableGutters sx={{ py: 0 }}>
                ...
                <ListItemText
                  ...
                  primary={<Typography variant="h4">{texte}</Typography>}
                  secondary={
                    <Typography
                      variant="subtitle2"
                      sx={{
